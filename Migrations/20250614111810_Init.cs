        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    flowerType = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    isFeaturedImage = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_ImageUploads_ProfileImageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PricingRuleId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    FlowerId = table.Column<long>(type: "bigint", nullable: true),
                    Condition = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    SpecialDay = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    StartTime = table.Column<TimeSpan>(type: "interval", nullable: true),
                    EndTime = table.Column<TimeSpan>(type: "interval", nullable: true),
                    StartDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    EndDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    PriceMultiplier = table.Column<decimal>(type: "numeric(18,4)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PricingRules_Products_FlowerId",
                        column: x => x.FlowerId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PricingRules_Users_CreatedBy",
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "ConcurrencyStamp", "CreationDate", "ModificationDate", "Name", "NormalizedName" },
                values: new object[,]
                {
                    { 1L, "4ecdc23d-855a-4f9a-b399-a6016d7b4f0b", new DateTime(2025, 6, 14, 11, 18, 9, 680, DateTimeKind.Utc).AddTicks(9373), new DateTime(2025, 6, 14, 11, 18, 9, 680, DateTimeKind.Utc).AddTicks(9374), "Admin", "ADMIN" },
                    { 2L, "430d10dc-b0a3-43b1-8dfb-9a3e0c1c966e", new DateTime(2025, 6, 14, 11, 18, 9, 680, DateTimeKind.Utc).AddTicks(9471), new DateTime(2025, 6, 14, 11, 18, 9, 680, DateTimeKind.Utc).AddTicks(9472), "User", "USER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PricingRules_CreatedBy",
                table: "PricingRules",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_PricingRules_FlowerId_Priority",
                table: "PricingRules",
                columns: new[] { "FlowerId", "Priority" });
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ImageUploads_Users_UserId",
                table: "ImageUploads",
                column: "UserId",
                principalTable: "Users",
                principalColumn: "Id",
